...
def add_signature():
    ...
    try:
        ...
        insert_position = fitz.Point(last_coord.x0, last_coord.y1 + 5)
        
        # Define the size of the signature (reduced by 25%)
        sig_width = int(signature_image.width * 0.75)  # Reduce width by 25%
        sig_height = int(signature_image.height * 0.75)  # Reduce height by 25%
